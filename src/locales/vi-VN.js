export default {
  ...
  'menu.order.orderconfirm':'Xác nhận đặt cọc',    
  'menu.order.confirmdelivery':'Xác nhận hàng về',    
  'menu.order.orderarrived':'Hàng đã về',    
  'menu.user.register':'Đăng ký',    
